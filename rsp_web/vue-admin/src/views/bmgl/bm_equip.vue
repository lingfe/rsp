		...
		data(){
			return{
				...
				types:{
					checked:'20001',
					type:1,
					data:[{text:'设备类型',id:'20001'},{text:'设备用途',id:'20002'},{text:'附件类别',id:'20003'}],
					textfield:'text',
					valuefield:'id'
				},
				dataTable:{
					...
					{label:'是否预排',prop:'is_walkthrough',width:100,show:false,belong:'yp'},
					{label:'预排名称',prop:'walkthrough_name',width:120,show:false,belong:'yp'},
					{label:'预排周期',prop:'walkthrough_cycle',width:100,show:false,belong:'yp'},
...
//				});
			...
			typeChange(val){
				...
				if(val==20003)this.dataTable.tr.forEach(d => {if(d.belong=='yp')d.show=true;if(d.prop=='is_walkthrough')d.show='template';});
