		...
		data(){
			return{
				...
				types:{
					checked:'10001',
					type:1,
					data:[{text:'性别',id:'10001'},{text:'岗位',id:'10002'},{text:'职称',id:'10003'},{text:'工作性质',id:'10004'},{text:'职业照射分类',id:'10005'},{text:'附件类别',id:'10006'}],
//					data:[{text:'性别',id:'1'},{text:'职位',id:'2'},{text:'岗位',id:'3'},{text:'工作性质',id:'4'},{text:'职业照射分类',id:'5'},{text:'附件分类',id:'6'}],
					textfield:'text',
					valuefield:'id'
				},
				dataTable:{
		...
		methods:{
			...
			typeChange(val){
				...
				if(val==10006)this.dataTable.tr.forEach(d => {if(d.belong=='yp')d.show=true;if(d.prop=='flag_yp')d.show='template';});
