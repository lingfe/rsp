		...
		<el-dialog :data='showData'  :title="calcTitle()" :visible.sync="showData.dialogVisible" :close-on-click-modal='false' class='depart_dia'>
			    	<el-form ref="form" :model="form" :inline='true' label-width='100px' :rules='rules'>
			    		<el-row class='my-form-item'>
								<el-col :span='12'>
									<el-form-item label="科室名称" prop='ks_name'>
										<el-input v-model='form.ks_name'></el-input>
									</el-form-item>
								</el-col>
								<el-col :span='12'>
									<el-form-item label="科室属性" prop='kssx_id'>
										<el-select v-model="form.kssx_id">
			    		...
			    		<el-row class='my-form-item'>
								<el-col :span='12'>
									<el-form-item label="电话" prop='ks_tel'>
										<el-input v-model='form.ks_tel'></el-input>
									</el-form-item>
								</el-col>
								<el-col :span='12'>
									<el-form-item label="负责人" prop='ks_fzr'>
										<el-input v-model='form.ks_fzr'></el-input>
									</el-form-item>
								</el-col>
			    		</el-row>
			    		<el-row class='my-form-item'>
	...
	export default{
		...
		data(){
			return {
				...
				dialogVisible:true,
				rules:{
					ks_name:[{required:true,message:'科室名称不能为空',trigger:'blur'}],
					kssx_id:[{required:true,message:'请选择科室属性',trigger:'blur'}]
				},
				form:{
					ks_name:'',
					kssx_id:'',
		...
		methods:{
			...
			sure(){
				...
				let department_attribute=$this.department_attributeArr.filter(d => d.id==$this.form.kssx_id)[0].coding_name;
