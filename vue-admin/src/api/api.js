...
export const getEquipList = params => {return util.myPost(`${base}/t_yy_sb_sbda/pageSelect`,params).then(res => res.data)};
export const createNewEquip = params => {return util.myPost(`${base}/t_yy_sb_sbda/save`,params).then(res => res.data)};
export const editEquip = params => {return util.myPost(`${base}/t_yy_sb_sbda/update`,params).then(res => res.data)};
export const deleteEquip = params => {return util.myPost(`${base}/t_yy_sb_sbda/deleteWhereId`,params).then(res => res.data)};
export const oneEquip = params => {return util.myPost(`${base}/t_yy_sb_sbda/getWhereId`,params).then(res => res.data)};

export const getHj = params => {return util.myPost(`${base}/t_mark_info/getWhere`,params).then(res => res.data)};

export const createNewYp = params => {return util.myPost(`${base}/equipment_walkthrough/save_list`,params).then(res => res.data)};
export const editYp = params => {return util.myPost(`${base}/equipment_walkthrough/update_list`,params).then(res => res.data)};

export const getFj = params => {return util.myPost(`${base}/enclosure/pageSelect`,params).then(res => res.data)};
export const deleteFj = params => {return util.myPost(`${base}/enclosure/deleteWhereId`,params).then(res => res.data)};
export const downFj = params => {return util.myPost(`${base}/enclosure/fileDownLoad`,params).then(res => res.data)};
